...
/backend/v1/user/:user/skill/:skill|POST  |更新技能|`user`: 用户(地址)<br>`skill`: 技能
...
curl -s -X POST -H 'application/x-www-form-urlencoded' -d 'skill=s1' '47.92.64.129/backend/v1/user/u1/skill' | jq .
```
返回
```json
{
